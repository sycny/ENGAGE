...
from simclr import Encoder, Model, EncoderGAT
...
def gridtrain():
    ...
    model = Model(encoder, num_hidden, num_mid_hidden, tau).to(device)
    ...
    for epoch in tqdm(range(1, num_epochs + 1)):
        ...
        if epoch < (args.start_e*num_epochs):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./simclr_self_guided.yaml')
    parser.add_argument('--lrdec_1', type=float, default=0.8)
    parser.add_argument('--lrdec_2', type=int, default=100)
    parser.add_argument('--gpu_num', type=str, default='cuda')
    parser.add_argument('--runtimes', type=int, default =5)
    parser.add_argument('--start_e', type=int, default =0.3)
