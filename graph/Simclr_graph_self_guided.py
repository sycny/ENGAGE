...
from graphsimclr import EncoderGIN, Model
...
def train(model, optimizer, dataloader, epoch):
    ...
    for data in dataloader:
        ...
        loss = model.loss(z1, z2, data.batch)
        loss.backward()
        optimizer.step()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config_defaults_simclr_guided.yaml')
